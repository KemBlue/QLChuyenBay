...
public class UpdateData {
    ...
    public static boolean updateMayBay(MayBay mayBay) {
     ...
     public static boolean updateNhanvien(NhanVien nhanvien) {
      ...
      public static boolean updateNhanVien1(NhanVien1 nv1) {
        String sqlCommand = "update dbo.NHANVIEN set  SDT=? , TENNHANVIEN = ?"+"where TENDNHAP=?" ;
         
        try { 
            DataConnection.createStatement();
            PreparedStatement  ps = DataConnection.connection.prepareStatement(sqlCommand);
 
            ps.setString(1, nv1.getSDT());
            ps.setString(2, nv1.getTenNhanVien());
            ps.setString(3, nv1.getTenDangNhap());
            return ps.executeUpdate() > 0;
    ...
    public static void updateNhanvien1(NhanVien1 nv1) {
