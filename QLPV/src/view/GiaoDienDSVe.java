	  ...
	  for(int j=1;j<=6;j++)
          {
	  	 JButton btn =new JButton();
                 btn.setBounds(50+(j-1)*(kichthuoc+10)+100*(j>3?1:0),10+i,kichthuoc,kichthuoc);
                 jPanel1.add(btn);
                 btn.setBackground(new java.awt.Color(200, 200, 200));
                 jButton2.setBackground(new java.awt.Color(200, 200, 200));
                 btn.setText(String.valueOf(chiso));
...
//        if(Controller.tk.getLoaiTaiKhoan().equals("guest"))
        if (new java.awt.Color(200, 200, 200).equals(btn.getBackground()))
        {
...
//        }
       GiaoDienChuyenBay frm = new GiaoDienChuyenBay();
       frm.show();
       this.dispose();
