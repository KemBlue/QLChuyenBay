...
public class GiaoDienDoiMatKhau extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(baoloi, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        StringBuilder sb = new StringBuilder();
          DataValidator.validateEmpty(jPasswordField1, sb, "Mật khẩu hiện tại không được để trống");
          DataValidator.validateEmpty(jPasswordField2, sb, "Mật khẩu mới không được để trống");
          DataValidator.validateEmpty(jPasswordField3, sb, "Xác thực mật khẩu không được để trống");
          if(sb.length()>0){
            MessageLogin.showErrorDangnhap(this, sb.toString(), "Lỗi");
            return;
        }
        if (jPasswordField1.getText().equals(controller.Controller.tk.getMatKhau()) == false)
